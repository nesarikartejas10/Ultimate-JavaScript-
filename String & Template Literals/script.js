...
//? Strings in JavaScript are a fundamental data type that represents a sequence of characters. and also strings are immutable which means once we create a string it can not be modified.

// Note:
//? Strings created by 4 ways
// 1. Double quote ("")
// 2. Single quote ('')
// 3. Backtics (``)
// 4. String constructor (new String(''))
...
// let result = text.match("JavaScript"); //[JavaScript]
//behind the scene the js converts the normal text into regular expression text.match(/JavaScript/); without the g flag
...
// let matchResult = text.matchAll("JavaScript");
//  BTS the js converts the normal text into regular expression text.match(/JavaScript/g); also adds the g flag at the end
